...
#define YY_MAX_SHIFTREDUCE   70
#define YY_MIN_REDUCE        71
#define YY_MAX_REDUCE        96
#define YY_ERROR_ACTION      97
#define YY_ACCEPT_ACTION     98
#define YY_NO_ACTION         99
/************* End control #defines *******************************************/
...
{ 
  sqlite3Fts5ParseSetColset(pParse, yymsp[0].minor.yy46, yymsp[-2].minor.yy11);
  yylhsminor.yy24 = sqlite3Fts5ParseNode(pParse, FTS5_STRING, 0, 0, yymsp[0].minor.yy46); 
}
